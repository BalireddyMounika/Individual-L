...
class ImmunizationUserTypeView extends StatefulWidget {
  const ImmunizationUserTypeView({Key? key}) : super(key: key);
  static int familyMemberIDFromImmunization = 0;
  @override
  State<StatefulWidget> createState() => _ImmunizationUserTypeView();
}

class _ImmunizationUserTypeView extends State<ImmunizationUserTypeView> {
        ...
        GestureDetector(
          onTap: () {
            ...
            locator<NavigationService>()
                .navigateTo(Routes.selectImmunizationView );
          },
          child: Card(
            child: Padding(
                          ...
                          itemBuilder: (context, index){
                            return Container(
                              ...
                              child: GestureDetector(
                                onTap:(){
                                  var map = Map();
                                  ImmunizationUserTypeView.familyMemberIDFromImmunization =  _viewModel.familyMemberList[index].id??0;
                                  locator<NavigationService>().navigateTo(Routes.selectImmunizationView);
                                },
                                child: Center(
                                  child: Text(
