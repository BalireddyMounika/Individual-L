...
//   @override
//   State createState() {
//     return CustomPinViewState();
//   }
// }
//
// class CustomPinViewState extends State<CustomPinView> {
//   List<String>? _pin = [];
...
//     super.initState();
//
//     _pin = List<String>.generate(widget.fields,(i) => i);
//     _focusNodes = List<FocusNode>.generate(widget.fields,(i) => _focusNodes![i]);
//     _textControllers = List<TextEditingController>.generate(widget.fields,(i)=>_textControllers![i]);    WidgetsBinding.instance?.addPostFrameCallback((_) {
//       setState(() {
