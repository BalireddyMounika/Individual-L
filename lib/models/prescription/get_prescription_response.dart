...
class GetPrescriptionResponse {
  ...
  factory GetPrescriptionResponse.fromJson(String str) => GetPrescriptionResponse.fromMap(json.decode(str));
...
class Professional {
  ...
  factory Professional.fromMap(Map<String, dynamic> json) => Professional(
    ...
    appointmentType: json["AppointmentType"] == null ? null : List<dynamic>.from(json["AppointmentType"].map((x) => x)),
